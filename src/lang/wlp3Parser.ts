...
export class wlp3Parser extends Parser {
  ...
  public program(): ProgramContext {
    ...
    try {
      ...
      switch (this.interpreter.adaptivePredict(this._input, 0, this._ctx)) {
        case 1:
          _localctx = new MorefunctionsContext(_localctx)
          this.enterOuterAlt(_localctx, 1)
          {
            this.state = 30
            ;(_localctx as MorefunctionsContext)._fun = this.function()
            this.state = 31
            ;(_localctx as MorefunctionsContext)._prog = this.program()
          }
          break
        ...
        case 2:
          ...
          {
            this.state = 33
            ;(_localctx as MainmethodContext)._mainmethod = this.main()
          }
          break
      }
    } catch (re) {
      ...
      this.enterOuterAlt(_localctx, 1)
      {
        ...
        while (
          ...
          (((_la - 33) & ~0x1f) === 0 &&
            ((1 << (_la - 33)) &
              ((1 << (wlp3Parser.INT - 33)) |
                (1 << (wlp3Parser.STRING - 33)) |
                (1 << (wlp3Parser.ID - 33)) |
                (1 << (wlp3Parser.BOOL - 33)))) !==
              0)
        ) {
          {
            {
  ...
  public lvalue(): LvalueContext {
    const _localctx: LvalueContext = new LvalueContext(this._ctx, this.state)
...
export class MorefunctionsContext extends ProgramContext {
  ...
  public enterRule(listener: wlp3Listener): void {
    if (listener.enterMorefunctions) {
      listener.enterMorefunctions(this)
    }
  }
  // @Override
  public exitRule(listener: wlp3Listener): void {
    if (listener.exitMorefunctions) {
      listener.exitMorefunctions(this)
    }
  }
  // @Override
  public accept<Result>(visitor: wlp3Visitor<Result>): Result {
    if (visitor.visitMorefunctions) {
      return visitor.visitMorefunctions(this)
    } else {
      return visitor.visitChildren(this)
    }
  }
}
export class MainmethodContext extends ProgramContext {
  public _mainmethod!: MainContext
  public main(): MainContext {
  ...
  // @Override
  public enterRule(listener: wlp3Listener): void {
    if (listener.enterMainmethod) {
      listener.enterMainmethod(this)
    }
  }
  // @Override
  public exitRule(listener: wlp3Listener): void {
    if (listener.exitMainmethod) {
      listener.exitMainmethod(this)
    }
  }
  // @Override
  public accept<Result>(visitor: wlp3Visitor<Result>): Result {
    if (visitor.visitMainmethod) {
...
export class ExprContext extends ParserRuleContext {
  public INT(): TerminalNode | undefined {
    return this.tryGetToken(wlp3Parser.INT, 0)
  }
  public STRING(): TerminalNode | undefined {
    return this.tryGetToken(wlp3Parser.STRING, 0)
  }
  public BOOL(): TerminalNode | undefined {
    return this.tryGetToken(wlp3Parser.BOOL, 0)
  }
  ...
  public ID(): TerminalNode | undefined {
    return this.tryGetToken(wlp3Parser.ID, 0)
  }
